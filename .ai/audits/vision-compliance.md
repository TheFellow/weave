...
| Preserve prior art before major subsystems | **Implemented** | `.ai/prior-art/*` and ADRs 0001–0016, including compiler-plugin, content, contextual-linking, CodeGraph, Git semantic-diff, watch-mode warming, generic-mapper, release/security/performance, source-rich animated Graphviz, and managed-adapter ecosystem research | Research must continue for each future subsystem. |
