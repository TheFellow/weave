...
graph explorer, plus Git-aware semantic graph/API/impact/test diffs and optional
foreground watch-mode warming.
...
| Preserve prior art before major subsystems | **Implemented** | `.ai/prior-art/*` and ADRs 0001–0014, including compiler-plugin, content, contextual-linking, CodeGraph, Git semantic-diff, watch-mode warming, generic-mapper, release/security/performance, and animated Graphviz research | Research must continue for each future subsystem. |
