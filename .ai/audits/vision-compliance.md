...
| Preserve prior art before major subsystems | **Implemented** | `.ai/prior-art/*` and ADRs 0001–0015, including compiler-plugin, content, contextual-linking, CodeGraph, Git semantic-diff, watch-mode warming, generic-mapper, release/security/performance, and source-rich animated Graphviz research | Research must continue for each future subsystem. |
