...
| Preserve prior art before major subsystems | **Implemented** | `.ai/prior-art/*` and ADRs 0001–0017, including compiler-plugin, content, contextual-linking, CodeGraph, Git semantic-diff, watch-mode warming, generic-mapper, release/security/performance, source-rich animated Graphviz, managed-adapter ecosystem, and schema/build parser research | Research must continue for each future subsystem. |
